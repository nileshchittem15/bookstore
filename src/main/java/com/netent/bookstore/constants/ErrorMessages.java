package com.netent.bookstore.constants;

public class ErrorMessages {

    public static final String INVALID_SEARCH_REQUEST = "search request invalid";
    public static final String NO_MEDIA_POSTS_FOUND= "no media posts found";

    public static final String DUPLICATE_BOOK_EXCEPTION = "Book Already exists with ISBN: ";
